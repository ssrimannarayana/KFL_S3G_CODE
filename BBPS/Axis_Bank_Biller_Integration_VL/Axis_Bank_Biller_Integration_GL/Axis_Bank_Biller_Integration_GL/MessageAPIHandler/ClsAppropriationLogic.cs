...
public class ClsAppropriationLogic
{
    ...
    /// <returns></returns>
    public DataTable FunPubReceiptAppropriationCalculation(Page thisPage, decimal decReceiptAmt, int intLOB_ID, int intCompanyId, int intBranch_ID, int intCustomer_ID, String strAccounts)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                DataTable dtInstallments = Utility.GetDefaultData("S3G_GET_RECEIPT_INSTALLMENT_NO_CHRGS", dictProcParam);
            ...
            if (dtAppropriationList != null)
            {
                ...
                {
                    decSuffixValue = objsession.ProGpsSuffixRW == 1 ? Convert.ToDecimal(0.9) : objsession.ProGpsSuffixRW == 2 ? Convert.ToDecimal(0.09) : objsession.ProGpsSuffixRW == 3 ? Convert.ToDecimal(0.009) : Convert.ToDecimal(0.0009);
    ...
    /// <returns></returns>
    public DataTable FunPubReceiptAppropriationCalculation(Page thisPage, decimal decReceiptAmt, int intLOB_ID, int intCompanyId, int intBranch_ID, int intCustomer_ID)
    {
        DataTable dtAppropriationCalList = new DataTable();
        try
        {
...
/// <returns></returns>
    ...
    public DataSet FunPubGetApprppriationLogicDetails(int intLOB_ID, int intCompanyId, int intBranch_ID, int intCustomer_ID)
    {
        ...
        return Utility.GetDataset("S3G_CLN_GetPendingInstallmentWithAppropriationLogic", dictProcParam);
    }
...
public class ChangedCodePartOnDATE29042011
{
    ...
    public DataSet FunPubGetApprppriationLogicDetails(int intLOB_ID, int intCompanyId, int intAppropriationType, string XmlAccountNo)
    {
        ...
        return Utility.GetDataset("S3G_CLN_GetAppropriationLogicDetails", dictProcParam);
    }
